# Generated by Powerlevel10k configuration wizard on 2020-03-18 at 21:59 EDT.
...
# 24h time, vertical separators, sharp heads, slanted tails, 2 lines, solid, no frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_AZURE_SHOW_ON_COMMAND='az|terraform|pulumi|helm|helmfile|kubectl'
